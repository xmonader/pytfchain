...
from tfchain.errors import *  # FIXME
...
class TFChainExplorerGetClientStub:
    ...
    def block_get(self, height):
        ...
        if not height in self._blocks:
            raise errors.ExplorerNoContent("no content found for block {}".format(
    ...
    def hash_get(self, hash):
        ...
        if not hash in self._hashes:
            raise errors.ExplorerNoContent("no content found for hash {}".format(
    ...
    def threebot_record_get(self, identifier, endpoint):
        ...
        if identifier.isdigit():
            try:
                ...
                raise errors.ExplorerNoContent(
    ...
    def mint_condition_get(self, height, endpoint):
        ...
        if len(self._mint_conditions) == 0:
            raise errors.ExplorerServerError(
