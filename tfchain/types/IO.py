...
class CoinInput(BaseDataTypeClass):
    ...
    def from_json(cls, obj):
        return cls(
            ...
            fulfillment=fulfillments.from_json(obj['fulfillment']))
    ...
    def from_coin_output(cls, co):
        ...
        ci = cls(
            parentid=co.id,
            fulfillment=fulfillments.from_condition(co.condition))
        ci.parent_output = co
        return ci
...
class CoinOutput(BaseDataTypeClass):
    ...
    def from_json(cls, obj):
        return cls(
            ...
            condition=conditions.from_json(obj['condition']))
...
class BlockstakeInput(BaseDataTypeClass):
    ...
    def from_blockstake_output(cls, bso):
        ...
        bsi = cls(
            parentid=bso.id,
            fulfillment=fulfillments.from_condition(bso.condition))
